...
/***/ function(module, exports, __webpack_require__) {
	...
	Webflow.define('scroll', module.exports = function($, _) {
	  ...
	  function findEl(hash, e) {
	    ...
	    var offset = $('.navbar').outerHeight()+10; /* CHANGED TO MATCH THE HEIGHT OF THE FIXED NAVBAR*/
...
Webflow.require('ix').init([
  ...
  {"slug":"show-class-overlay-elements","name":"Show class overlay elements","value":{"style":{},"triggers":[{"type":"hover","selector":".class-read-more-title","descend":true,"stepsA":[{"wait":100},{"display":"block","opacity":1,"transition":"transform 300ms ease 0ms, opacity 200ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"wait":100},{"opacity":0,"transition":"transform 200ms ease 0ms, opacity 200ms ease 0ms","x":"0px","y":"-10px","z":"0px"},{"display":"none"}]},{"type":"hover","selector":".classes-block-title","descend":true,"stepsA":[{"transition":"transform 200ms ease 0ms","x":"0px","y":"-5px","z":"0px"}],"stepsB":[{"transition":"transform 300ms ease 0ms","x":"0px","y":"5px","z":"0px"}]}]}},
  ...
  {"slug":"slide-title-3","name":"Slide title 3","value":{"style":{"opacity":0,"x":"0px","y":"20px","z":"0px"},"triggers":[{"type":"slider","stepsA":[{"wait":800},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 300ms ease 0ms, opacity 300ms ease 0ms","x":"0px","y":"20px","z":"0px"}]}]}},
